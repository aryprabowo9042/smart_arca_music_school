...
// Cek apakah user sudah login? Jika ya, langsung lempar ke dashboard masing-masing
// Ini mencegah user yang sudah login melihat landing page lagi
        ...
        <div class="container">
            ...
            <div class="grid">
                ...
                <div class="card">
                    ...
                    <p>Pelajari teknik dasar hingga mahir, baik Klasik maupun Pop dengan metode yang menyenangkan dan terstruktur.</p>
                </div>

                <div class="card">
                    <span class="icon">🎸</span>
                    <h3>Gitar (Akustik & Elektrik)</h3>
                    <p>Kuasai chord, melodi, teknik picking, hingga shredding bersama instruktur ahli berpengalaman.</p>
                </div>

                <div class="card">
                    <span class="icon">🥁</span>
                    <h3>Drum</h3>
                    <p>Bangun ritme, tempo yang kuat, dan koordinasi tubuh dengan kurikulum drum modern.</p>
                </div>

                <div class="card">
                    <span class="icon">🎤</span>
                    <h3>Vokal</h3>
                    <p>Olah vokalmu agar lebih powerfull, pitch control yang tepat, dan bernyanyi dengan teknik pernapasan yang benar.</p>
                </div>

                <div class="card">
                    <span class="icon">🎼</span>
                    <h3>Music Theory</h3>
                    <p>Pahami bahasa musik (not balok, harmoni, solfeggio) untuk mendukung kemampuan bermusikmu secara akademis.</p>
                </div>
    ...
    <section id="tentang" class="section" style="background-color: #f9f9f9;">
        <div class="container" style="text-align: center; max-width: 900px;">
            ...
            <div style="display: flex; justify-content: center; flex-wrap: wrap; gap: 20px;">
                <div style="background: white; padding: 15px 25px; border-radius: 50px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
