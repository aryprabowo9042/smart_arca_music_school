<?php
// LOGIKA: Cek apakah user sudah login atau belum melalui cookie
        ...
        <div class="max-w-6xl mx-auto flex justify-between items-center">
            ...
            <div class="flex gap-4">
                <?php if($is_login): ?>
                    ...
                    <a href="logout.php" class="bg-white hover:bg-slate-100 text-red-600 px-4 py-2 rounded-full font-black text-xs uppercase shadow-lg transition">
                        Keluar
                    </a>
                <?php else: ?>
                    <a href="index.php" class="bg-yellow-400 hover:bg-yellow-300 text-red-800 px-8 py-3 rounded-full font-black text-xs uppercase shadow-lg transition tracking-widest">
    ...
    <header class="py-20 px-6 bg-gradient-to-b from-red-50 to-white">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <h1 class="text-5xl md:text-7xl font-black text-slate-900 italic uppercase tracking-tighter mb-6 leading-tight">
                ...
                Lewat <span class="text-yellow-500">Nada & Irama</span>
            </h1>
            ...
            <div class="flex justify-center gap-4">
                <a href="index.php" class="bg-red-600 text-white px-8 py-4 rounded-2xl font-black uppercase shadow-2xl hover:bg-red-700 transition transform hover:-translate-y-1">
                    Daftar Sekarang
                </a>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-6xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white border-2 border-slate-100 p-8 rounded-[2rem] shadow-xl hover:border-red-500 transition group">
                ...
                <div class="bg-white border-2 border-slate-100 p-8 rounded-[2rem] shadow-xl hover:border-yellow-400 transition group">
