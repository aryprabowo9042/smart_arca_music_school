<?php
// Cek apakah user sudah login atau belum untuk mengubah tampilan tombol
...
<body class="bg-slate-50 text-slate-900">
    ...
    <nav class="fixed w-full z-50 top-0 px-4 py-4">
        <div class="max-w-7xl mx-auto glass rounded-[2rem] shadow-2xl border-b-4 border-yellow-400 px-6 py-3 flex justify-between items-center transition-all">
            ...
            <div class="flex items-center gap-4">
                <?php if ($is_logged_in): ?>
                    <a href="<?php echo $dashboard_link; ?>" class="bg-red-600 hover:bg-red-700 text-yellow-400 px-6 py-2.5 rounded-2xl font-black text-xs shadow-lg transition flex items-center gap-2">
                ...
                <?php else: ?>
                    <a href="api/admin/login.php" class="bg-red-600 hover:bg-red-700 text-yellow-400 px-8 py-2.5 rounded-2xl font-black text-xs shadow-lg transition flex items-center gap-2 border-b-4 border-red-800">
                        <i class="fas fa-user-circle text-lg"></i> LOGIN SISWA/GURU
                    </a>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
            <div class="space-y-8 text-center lg:text-left">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                    <a href="https://wa.me/62895360796038" target="_blank" class="bg-yellow-400 hover:bg-yellow-500 text-red-700 px-10 py-5 rounded-[2rem] font-black text-xl shadow-2xl transition transform hover:-translate-y-2 flex items-center justify-center gap-3 border-b-8 border-yellow-600">
                        <i class="fab fa-whatsapp text-3xl"></i>
                        HUBUNGI FIA
                    </a>
                    <a href="#program" class="bg-white hover:bg-slate-50 text-slate-700 px-10 py-5 rounded-[2rem] font-bold text-xl shadow-lg border border-slate-200 flex items-center justify-center">
                        LIHAT PROGRAM
                    </a>
                </div>
            </div>
    ...
    <section id="program" class="py-24 bg-white border-t-8 border-yellow-400 relative overflow-hidden">
        <div class="max-w-7xl mx-auto px-6 text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="bg-slate-50 p-10 rounded-[3rem] border-b-[12px] border-red-600 shadow-xl hover:bg-white hover:-translate-y-4 transition-all duration-500 group">
                    <div class="w-20 h-20 bg-red-600 text-white rounded-[1.5rem] flex items-center justify-center text-3xl mb-8 shadow-xl group-hover:rotate-12 transition-all">
                ...
                <div class="bg-slate-50 p-10 rounded-[3rem] border-b-[12px] border-yellow-400 shadow-xl hover:bg-white hover:-translate-y-4 transition-all duration-500 group">
                    <div class="w-20 h-20 bg-yellow-400 text-red-700 rounded-[1.5rem] flex items-center justify-center text-3xl mb-8 shadow-xl group-hover:rotate-12 transition-all">
                ...
                <div class="bg-slate-50 p-10 rounded-[3rem] border-b-[12px] border-yellow-400 shadow-xl hover:bg-white hover:-translate-y-4 transition-all duration-500 group">
                    <div class="w-20 h-20 bg-slate-800 text-white rounded-[1.5rem] flex items-center justify-center text-3xl mb-8 shadow-xl group-hover:rotate-12 transition-all">
    ...
    <footer class="bg-slate-900 text-white pt-24 pb-12 border-t-[16px] border-red-600">
        <div class="max-w-7xl mx-auto px-6 text-center">
            <h2 class="text-4xl font-black italic tracking-tighter mb-4 uppercase">Smart Arca <span class="text-yellow-400 font-normal">Music School</span></h2>
