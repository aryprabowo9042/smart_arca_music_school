    ...
    <div class="max-w-7xl mx-auto p-6 md:p-10">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
                ...
                <div class="bg-white p-8 rounded-[3rem] shadow-2xl border-2 border-red-700 sticky top-28">
                    ...
                    <form method="POST" class="space-y-4 text-[10px] font-black uppercase tracking-widest">
                        ...
                        <div>
                            ...
                            <input type="date" name="tgl" value="<?php echo $data_edit['tanggal'] ?? date('Y-m-d'); ?>" class="w-full p-4 rounded-2xl bg-slate-50 border-2 border-slate-50 focus:border-red-600 outline-none font-bold italic" required>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="number" name="nominal" value="<?php echo $data_edit['nominal'] ?? ''; ?>" class="w-full p-4 rounded-2xl bg-slate-50 border-2 border-slate-50 outline-none font-bold italic" placeholder="Contoh: 50000" required>
                        </div>
                        ...
                        <?php if($data_edit): ?>
                            <a href="honor.php" class="block text-center text-slate-400 font-black text-[9px] uppercase mt-2 hover:text-red-600">Batal Edit</a>
                        <?php endif; ?>
                    </form>
                </div>
            </div>
            ...
            <div class="lg:col-span-2 space-y-12">
                ...
                <section>
                    <h2 class="text-xl font-black text-slate-800 uppercase italic mb-6 border-b-2 border-red-700 pb-2 inline-block leading-none"><i class="fas fa-hand-holding-usd mr-2 text-red-700"></i> Antrean Bayar Honor</h2>
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div class="bg-white p-6 rounded-[2rem] shadow-lg flex flex-col md:flex-row justify-between items-center border-l-[10px] border-red-700 gap-4">
                            <div>
                                ...
                                <p class="text-[10px] font-black text-red-600 italic mt-1 uppercase">Hak Honor (50%): Rp <?php echo number_format($row['total']*0.5, 0, ',', '.'); ?></p>
                            </div>
                            <form method="POST">
