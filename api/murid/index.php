...
// 2. KONEKSI (Sesuai gambar: koneksi.php ada di folder api)
...
<body class="bg-slate-50 min-h-screen pb-20">
    ...
    <nav class="bg-indigo-900 shadow-xl px-6 py-4 flex justify-between items-center mb-6 border-b-4 border-yellow-400 sticky top-0 z-50 text-white font-black italic uppercase">
        ...
        <a href="../index.php" class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-xl text-[10px] font-black transition shadow-lg flex items-center gap-2">
    ...
    <div class="max-w-4xl mx-auto px-4">
        <div class="bg-white p-8 rounded-[2.5rem] shadow-xl mb-10 border-l-[12px] border-indigo-600 flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div class="bg-slate-50 p-5 rounded-3xl border-2 border-dashed border-slate-200 text-right">
                <p class="text-[9px] font-black text-slate-400 uppercase leading-none mb-1 italic">Guru Pengajar</p>
                <p class="text-xl font-black text-indigo-900 italic uppercase"><?php echo $data_j['nama_guru'] ?? 'Guru Smart Arca'; ?></p>
            </div>
        </div>

        <h2 class="text-xl font-black text-indigo-900 uppercase italic mb-6"><i class="fas fa-book-open mr-2 text-yellow-500"></i> Riwayat Perkembangan Belajar</h2>

        <div class="space-y-6">
            <?php 
            $id_j_murid = $data_j['id'] ?? 0;
            // Menggunakan nama kolom sesuai gambar DESCRIBE: materi_ajar & perkembangan_murid
            ...
            ?>
                <div class="text-center p-12 bg-white rounded-[2.5rem] shadow-md text-slate-300 font-bold uppercase italic border-2 border-dashed border-slate-100">
                    <i class="fas fa-ghost text-5xl mb-3 block"></i> Belum ada riwayat pertemuan.
                </div>
            <?php 
            endif;
            ...
            <div class="bg-white rounded-[2.5rem] shadow-xl border border-slate-100 p-8 hover:border-indigo-200 transition">
                <div class="flex flex-col md:flex-row justify-between mb-4 border-b pb-4 border-slate-50">
                    ...
                    <div class="md:text-right mt-2 md:mt-0">
                        <p class="text-xs font-bold text-indigo-600 bg-indigo-50 px-3 py-1 rounded-full inline-block">
